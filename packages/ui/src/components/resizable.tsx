...
function PageResizableHandle({
  ...
  return (
    ...
    >
      {withHandle && (
        <div className="rounded-xs z-10 flex h-4 w-3 items-center justify-center">
          <span className="bg-border h-12 w-1.5 rounded" />
        </div>
      )}
    </ResizablePrimitive.PanelResizeHandle>
  );
...
export { ResizablePanelGroup, ResizablePanel, ResizableHandle, PageResizableHandle };
